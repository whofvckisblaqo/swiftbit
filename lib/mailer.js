  ...
  resend.emails.send({
    ...
    html: baseTemplate(`
      ...
      <p style="color:#6b7280;font-size:12px;text-align:center;margin:0">
        Need help? Reach us at <a href="mailto:swiftbitsupport@outlook.com" style="color:#4ade80;text-decoration:none">swiftbitsupport@outlook.com</a>
      </p>
    `),
  }).catch(console.error);
}
...
export async function sendTransactionPendingEmail(email, name, tx) {
  ...
  resend.emails.send({
    ...
    html: baseTemplate(`
      ...
      <p style="color:#6b7280;font-size:12px;text-align:center;margin:0">
        Questions? Contact us at <a href="mailto:swiftbitsupport@outlook.com" style="color:#4ade80;text-decoration:none">swiftbitsupport@outlook.com</a>
      </p>
    `),
  }).catch(console.error);
}
