    ...
    <main>
      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        ...
        <div className="container relative z-10 text-center max-w-3xl mx-auto">
          ...
          <a href="mailto:security@swiftbit.com"
        ...
        <div className="container max-w-3xl mx-auto">
          <div className="glass border border-white/5 rounded-[var(--radius-card)] p-8">
            ...
            <ul className="space-y-3 text-gray-400 text-sm leading-relaxed">
              ...
              <li>• Report all findings to <a href="mailto:security@swiftbit.com" className="text-green-400 hover:text-green-300">security@swiftbit.com</a> with full reproduction steps.</li>
            </ul>
